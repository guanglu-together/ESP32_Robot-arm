...
/* -------------------------------------------------
Derivative Work & AI Vision Integration (c) 2026 [guanglu-together]
Added Features (二次开发新增功能): 
- UDP Real-time Vision Control (YOLOv8 + RTX4050)
- mDNS & OTA Wireless Support
- Action Record/Playback State Machine
-------------------------------------------------*/
